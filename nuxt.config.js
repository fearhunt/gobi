export default {
  ...
  head: {
    ...
    link: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,300;1,400;1,500;1,600;1,700;1,800&display=swap" }
    ],
    script: [
      { src: "https://kit.fontawesome.com/170c7b125d.js", body: true, crossorigin: "anonymous" }
    ]
  },
  ...
  axios: {
    baseURL: "https://gobi-app.herokuapp.com/"
  },
